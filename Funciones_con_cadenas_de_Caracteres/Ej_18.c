/*Este ejercicio ya lo hice en la guia 3. Hice mi version de todas esa funciones, e hice programas donde se implementa la funcion original. En el ejercicio 12 implemente strcpy.*/
